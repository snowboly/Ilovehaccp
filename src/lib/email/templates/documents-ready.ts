type DocumentsReadyEmailProps = {
  appUrl: string;
};

export function documentsReadyEmailHtml(props: DocumentsReadyEmailProps): string {
  const dashboardUrl = `${props.appUrl}/dashboard`;
...
<head>
  ...
  <title>Your documents are ready</title>
...
<body>
  <div class="wrapper">
    <div class="container">
      ...
      <div class="content">
        <h1 class="h1">Your documents are ready</h1>

        <p class="text">Hi there,</p>
        <p class="text">Your generated documents are ready in your dashboard.</p>
        ...
        <p class="text" style="font-size:14px; color:#94a3b8; margin-top:32px; text-align:center;">
          For privacy and security, download links are available only inside your account.
        </p>
      </div>
