  ...
  en: {
    ...
    landing: {
      hero: {
        ...
        subtitle: "Create a compliant HACCP plan in minutes. AI-powered food safety for restaurants, manufacturers, and catering.",
        check1: "Compliant",
  ...
  es: {
    ...
    landing: {
      hero: {
        ...
        subtitle: "Cree un plan HACCP profesional en minutos. Seguridad alimentaria con IA para restaurantes, fabricantes y catering.",
  ...
  fr: {
    ...
    landing: {
      hero: {
        ...
        subtitle: "Créez un plan HACCP professionnel en quelques minutes. La sécurité alimentaire par IA pour les restaurants, les fabricants et le traiteur.",
        check1: "Conforme",
  ...
  pt: {
    ...
    landing: {
      hero: {
        ...
        subtitle: "Crie um plano HACCP profissional em minutos. Segurança alimentar com IA para restaurantes, fabricantes e catering.",
