  ...
  en: {
    ...
    landing: {
      ...
      howItWorks: {
        ...
        s2_desc: "We generate your custom HACCP plan automatically using AI.",
  ...
  es: {
    ...
    landing: {
      ...
      howItWorks: {
        ...
        s2_desc: "Generamos su plan HACCP personalizado automáticamente con IA.",
  ...
  fr: {
    ...
    landing: {
      ...
      howItWorks: {
        ...
        s2_desc: "Nous générons votre plan HACCP personnalisé automatiquement avec l'IA.",
  ...
  pt: {
    ...
    landing: {
      ...
      howItWorks: {
        ...
        s2_desc: "Geramos o seu plano HACCP personalizado automaticamente com IA.",
