        ...
        <div className="grid lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-8 space-y-16">
            ...
            <Section 
              ...
              content={
                <p>
                  <strong>We do not guarantee that any HACCP plan or document generated by this Service will pass any specific audit, inspection, or regulatory review.</strong> Food safety regulations (including FDA, USDA, EHO, BRCGS, SQF) vary significantly by jurisdiction and inspector interpretation. The documents provided are templates based on general principles and must be verified, customized, and validated by a qualified professional for your specific facility. Failure to pass an audit is the sole responsibility of the User.
                </p>
              }
