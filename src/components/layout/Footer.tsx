    ...
    <footer className="bg-slate-950 text-slate-400 py-16 border-t border-slate-900">
      <div className="container px-4 mx-auto grid md:grid-cols-4 gap-12 mb-12">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm font-medium">
            <li><Link href="/resources#articles" className="hover:text-blue-400 transition-colors">Knowledge Base</Link></li>
            <li><Link href="/resources#faqs" className="hover:text-blue-400 transition-colors">Compliance FAQs</Link></li>
            <li><Link href="/resources" className="hover:text-blue-400 transition-colors">Latest Articles</Link></li>
          </ul>
        </div>
        <div>
